...
class _GoalWidgetState extends State<GoalWidget> {
  ...
  void initState() {
    ...
    _model.deadlineFocusNode!.addListener(() => setState(() {}));
    _model.creditScoreTextController ??= TextEditingController();
    _model.creditScoreFocusNode ??= FocusNode();
    _model.creditScoreFocusNode!.addListener(() => setState(() {}));
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor: (_model.deadlineFocusNode
                                                  ?.hasFocus ??
                                              false)
                                    ...
                                    validator: _model
                                        .deadlineTextControllerValidator
                                        .asValidator(context),
                                  ),
                                  TextFormField(
                                    controller:
                                        _model.creditScoreTextController,
                                    focusNode: _model.creditScoreFocusNode,
                                    autofocus: false,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor: (_model.creditScoreFocusNode
                                                  ?.hasFocus ??
                                              false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model
                                        .creditScoreTextControllerValidator
                                        .asValidator(context),
                                    inputFormatters: [_model.creditScoreMask],
                                  ),
                                ]
